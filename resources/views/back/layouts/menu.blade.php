    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin.panel')}}">
                ...
                <div class="sidebar-brand-text mx-3">Temadio Admin</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse @if(Request::segment(2) == 'makaleler') show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item @if(Request::segment(2) == 'makaleler' && !Request::segment(3)) active @endif" href="{{route('makaleler.index')}}">Tüm Makaleler</a>
                        <a class="collapse-item @if(Request::segment(2) == 'makaleler' && Request::segment(3) == 'create') active @endif " href="{{route('makaleler.create')}}">Makale Oluştur</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse @if(Request::segment(2) == 'sayfalar') show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Makale İşlemleri</h6>
                        <a class="collapse-item @if(Request::segment(2) == 'sayfalar' && !Request::segment(3)) active @endif" href="{{route('page.index')}}">Tüm Sayfalar</a>
                        <a class="collapse-item @if(Request::segment(2) == 'sayfalar' && Request::segment(3) == 'create') active @endif " href="{{route('page.create')}}">Sayfa Oluştur</a>
                    </div>
                </div>
            </li>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <p class="text-center mb-2"><strong>Temadio</strong> ile blog vakti</p>
                <a class="btn btn-success btn-sm" href="https://temadio.com">Temadio</a>
            </div>
