...
<html lang="en">
    <head>
        ...
        <title>@yield('site_title','Blog Sitesi') - {{$config->site_title}}</title>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="{{route('homepage')}}"><img src="{{asset($config->logo)}}" alt=""></a>
